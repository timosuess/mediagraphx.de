...
export default function PortfolioGrid() {
  ...
  }, [lightboxIdx, close, nav]);

  return (
    <>
      <section ref={ref} id="arbeiten" className="py-24 md:py-32 px-6 bg-dark-surface">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-2xl mb-20">
            <p className="text-orange font-heading font-semibold text-sm uppercase tracking-[0.3em] mb-4">Portfolio</p>
          ...
          <div className="port-grid grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {projects.map((p, i) => (
              <button key={p.title} onClick={() => open(i)}
                ...
                <div className="relative aspect-[4/3]">
                  ...
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-orange/70 transition-all duration-500 flex items-center justify-center">
                    <div className="text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 px-3">
      ...
      {lightboxIdx !== null && (
        <div className="fixed inset-0 z-[9999] bg-black/95 flex items-center justify-center" onClick={close}>
          ...
          <div className="relative w-[90vw] h-[80vh] max-w-5xl" onClick={(e) => e.stopPropagation()}>
            <Image src={projects[lightboxIdx].image} alt={projects[lightboxIdx].title} fill className="object-contain" sizes="90vw" />
          </div>
